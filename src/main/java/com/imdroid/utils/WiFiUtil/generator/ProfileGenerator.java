package com.imdroid.utils.WiFiUtil.generator;

import com.imdroid.pojo.bo.Const;
import com.imdroid.utils.WiFiUtil.Connector;
import com.imdroid.utils.WiFiUtil.config.Profile;
...
class GenThread implements Runnable {
    ...
    public void run() {
        ...
        FileUtils.writeToFile(Const.WiFiAddress.PROFILE_TEMP_PATH + "\\" + password + ".xml", profileContent);
    }
}
